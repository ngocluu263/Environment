...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plot.calculate_by_species'
        db.add_column(u'mrvapi_plot', 'calculate_by_species',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plot.calculate_by_species'
        db.delete_column(u'mrvapi_plot', 'calculate_by_species')
