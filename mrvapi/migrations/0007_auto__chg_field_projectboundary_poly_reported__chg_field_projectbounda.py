...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectBoundary.poly_reported'
        db.alter_column(u'mrvapi_projectboundary', 'poly_reported', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, geography=True))

        # Changing field 'ProjectBoundary.poly_mapped'
        db.alter_column(u'mrvapi_projectboundary', 'poly_mapped', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, geography=True))

    def backwards(self, orm):

        # Changing field 'ProjectBoundary.poly_reported'
        db.alter_column(u'mrvapi_projectboundary', 'poly_reported', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))

        # Changing field 'ProjectBoundary.poly_mapped'
        db.alter_column(u'mrvapi_projectboundary', 'poly_mapped', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
