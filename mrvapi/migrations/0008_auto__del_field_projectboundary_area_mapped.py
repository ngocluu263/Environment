...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectBoundary.area_mapped'
        db.delete_column(u'mrvapi_projectboundary', 'area_mapped')


    def backwards(self, orm):
        # Adding field 'ProjectBoundary.area_mapped'
        db.add_column(u'mrvapi_projectboundary', 'area_mapped',
