...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plot.project'
        db.add_column(u'mrvapi_plot', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mrvapi.Project'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plot.project'
        db.delete_column(u'mrvapi_plot', 'project_id')
