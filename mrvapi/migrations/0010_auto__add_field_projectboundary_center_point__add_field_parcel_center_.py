...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectBoundary.center_point'
        db.add_column(u'mrvapi_projectboundary', 'center_point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(blank=True, null=True, geography=True),
                      keep_default=False)

        # Adding field 'Parcel.center_point'
        db.add_column(u'mrvapi_parcel', 'center_point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(blank=True, null=True, geography=True),
                      keep_default=False)

        # Adding field 'Plot.center_point'
        db.add_column(u'mrvapi_plot', 'center_point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(blank=True, null=True, geography=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectBoundary.center_point'
        db.delete_column(u'mrvapi_projectboundary', 'center_point')

        # Deleting field 'Parcel.center_point'
        db.delete_column(u'mrvapi_parcel', 'center_point')

        # Deleting field 'Plot.center_point'
        db.delete_column(u'mrvapi_plot', 'center_point')
