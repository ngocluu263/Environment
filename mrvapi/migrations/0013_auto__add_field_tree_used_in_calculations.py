...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tree.used_in_calculations'
        db.add_column(u'mrvapi_tree', 'used_in_calculations',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tree.used_in_calculations'
        db.delete_column(u'mrvapi_tree', 'used_in_calculations')
    ...
    models = {
        ...
        u'mrvapi.tree': {
            ...
            'used_in_calculations': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'wood_gravity': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        }
    }
