...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plot.nontree_agb_tc_ha'
        db.alter_column(u'mrvapi_plot', 'nontree_agb_tc_ha', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Plot.nontree_bgb_tc_ha'
        db.alter_column(u'mrvapi_plot', 'nontree_bgb_tc_ha', self.gf('django.db.models.fields.FloatField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Plot.nontree_agb_tc_ha'
        db.alter_column(u'mrvapi_plot', 'nontree_agb_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Plot.nontree_bgb_tc_ha'
        db.alter_column(u'mrvapi_plot', 'nontree_bgb_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True))
