...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Parcel.area_mapped'
        db.delete_column(u'mrvapi_parcel', 'area_mapped')


        # Changing field 'Parcel.poly_reported'
        db.alter_column(u'mrvapi_parcel', 'poly_reported', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, geography=True))

        # Changing field 'Parcel.poly_mapped'
        db.alter_column(u'mrvapi_parcel', 'poly_mapped', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, geography=True))
        # Deleting field 'Plot.area_mapped'
        db.delete_column(u'mrvapi_plot', 'area_mapped')


        # Changing field 'Plot.poly_reported'
        db.alter_column(u'mrvapi_plot', 'poly_reported', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, geography=True))

        # Changing field 'Plot.poly_mapped'
        db.alter_column(u'mrvapi_plot', 'poly_mapped', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True, geography=True))

    def backwards(self, orm):
        # Adding field 'Parcel.area_mapped'
        db.add_column(u'mrvapi_parcel', 'area_mapped',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Parcel.poly_reported'
        db.alter_column(u'mrvapi_parcel', 'poly_reported', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))

        # Changing field 'Parcel.poly_mapped'
        db.alter_column(u'mrvapi_parcel', 'poly_mapped', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
        # Adding field 'Plot.area_mapped'
        db.add_column(u'mrvapi_plot', 'area_mapped',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Plot.poly_reported'
        db.alter_column(u'mrvapi_plot', 'poly_reported', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))

        # Changing field 'Plot.poly_mapped'
        db.alter_column(u'mrvapi_plot', 'poly_mapped', self.gf('django.contrib.gis.db.models.fields.PolygonField')(null=True))
