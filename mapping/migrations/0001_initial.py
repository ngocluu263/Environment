...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectPolygonMapped'
        db.create_table(u'mapping_projectpolygonmapped', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mrvapi.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('poly_vertices', self.gf('django.contrib.gis.db.models.fields.PolygonField')()),
        ...
        db.send_create_signal(u'mapping', ['ProjectPolygonMapped'])

        # Adding model 'ParcelPolygonMapped'
        db.create_table(u'mapping_parcelpolygonmapped', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mrvapi.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('poly_vertices', self.gf('django.contrib.gis.db.models.fields.PolygonField')()),
        ...
        db.send_create_signal(u'mapping', ['ParcelPolygonMapped'])

        # Adding model 'PointMapped'
        db.create_table(u'mapping_pointmapped', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mrvapi.Project'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('pType', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('sampling_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('marker', self.gf('django.contrib.gis.db.models.fields.PointField')()),
        ))
        db.send_create_signal(u'mapping', ['PointMapped'])


    def backwards(self, orm):
        # Deleting model 'ProjectPolygonMapped'
        db.delete_table(u'mapping_projectpolygonmapped')

        # Deleting model 'ParcelPolygonMapped'
        db.delete_table(u'mapping_parcelpolygonmapped')

        # Deleting model 'PointMapped'
        db.delete_table(u'mapping_pointmapped')
    ...
    models = {
        ...
        u'mapping.parcelpolygonmapped': {
            'Meta': {'object_name': 'ParcelPolygonMapped'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'poly_vertices': ('django.contrib.gis.db.models.fields.PolygonField', [], {}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mrvapi.Project']"})
        },
        u'mapping.pointmapped': {
            'Meta': {'object_name': 'PointMapped'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marker': ('django.contrib.gis.db.models.fields.PointField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'pType': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mrvapi.Project']"}),
            'sampling_type': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'mapping.projectpolygonmapped': {
            'Meta': {'object_name': 'ProjectPolygonMapped'},
            'area_mapped': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'area_reported': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
