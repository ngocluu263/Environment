...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EquationSpecies.wood_density'
        db.delete_column(u'allometric_equationspecies', 'wood_density')

        # Adding field 'EquationSpecies.region'
        db.add_column(u'allometric_equationspecies', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allometric.EquationRegion'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EquationSpecies.wood_density'
        db.add_column(u'allometric_equationspecies', 'wood_density',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EquationSpecies.region'
        db.delete_column(u'allometric_equationspecies', 'region_id')
