...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Equation.anatomy'
        db.add_column(u'allometric_equation', 'anatomy',
                      self.gf('django.db.models.fields.CharField')(default='SW', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Equation.anatomy'
        db.delete_column(u'allometric_equation', 'anatomy')


    models = {
        u'allometric.equation': {
            'Meta': {'object_name': 'Equation'},
            'anatomy': ('django.db.models.fields.CharField', [], {'default': "'SW'", 'max_length': '2'}),
