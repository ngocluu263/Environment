...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EquationSpecies.wood_gravity'
        db.add_column(u'allometric_equationspecies', 'wood_gravity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EquationSpecies.wood_gravity'
        db.delete_column(u'allometric_equationspecies', 'wood_gravity')
