...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equation.anatomy'
        db.alter_column(u'allometric_equation', 'anatomy', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Equation.anatomy'
        db.alter_column(u'allometric_equation', 'anatomy', self.gf('django.db.models.fields.CharField')(max_length=2))
