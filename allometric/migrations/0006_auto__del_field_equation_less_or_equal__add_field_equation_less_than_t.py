...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Equation.less_or_equal'
        db.delete_column(u'allometric_equation', 'less_or_equal')

        # Adding field 'Equation.less_than_ten'
        db.add_column(u'allometric_equation', 'less_than_ten',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Equation.less_or_equal'
        db.add_column(u'allometric_equation', 'less_or_equal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Equation.less_than_ten'
        db.delete_column(u'allometric_equation', 'less_than_ten')
