...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'allometric_equation', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allometric.EquationGroup'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'allometric.equation': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['allometric.EquationGroup']", 'null': 'True', 'blank': 'True'}),
        ...
        u'allometric.equationgroup': {
            'Meta': {'object_name': 'EquationGroup'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
