...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EquationCategory'
        db.create_table(u'allometric_equationcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'allometric', ['EquationCategory'])

        # Deleting field 'Equation.equationtype'
        db.delete_column(u'allometric_equation', 'equationtype_id')

        # Adding field 'Equation.category'
        db.add_column(u'allometric_equation', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['allometric.EquationCategory'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EquationCategory'
        db.delete_table(u'allometric_equationcategory')
        ...
        # Deleting field 'Equation.category'
        db.delete_column(u'allometric_equation', 'category_id')
