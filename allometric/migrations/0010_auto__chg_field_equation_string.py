...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Equation.string'
        db.alter_column(u'allometric_equation', 'string', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Equation.string'
        db.alter_column(u'allometric_equation', 'string', self.gf('django.db.models.fields.CharField')(max_length=100))
