...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlotCarbonStock.dbh_sd'
        db.add_column(u'measuring_plotcarbonstock', 'dbh_sd',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'PlotCarbonStock.wsg_sd'
        db.add_column(u'measuring_plotcarbonstock', 'wsg_sd',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'PlotCarbonStock.height_sd'
        db.add_column(u'measuring_plotcarbonstock', 'height_sd',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlotCarbonStock.dbh_sd'
        db.delete_column(u'measuring_plotcarbonstock', 'dbh_sd')

        # Deleting field 'PlotCarbonStock.wsg_sd'
        db.delete_column(u'measuring_plotcarbonstock', 'wsg_sd')

        # Deleting field 'PlotCarbonStock.height_sd'
        db.delete_column(u'measuring_plotcarbonstock', 'height_sd')
