...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreeAEQ.parcel'
        db.add_column(u'measuring_treeaeq', 'parcel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mrvapi.Parcel']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreeAEQ.parcel'
        db.delete_column(u'measuring_treeaeq', 'parcel_id')
