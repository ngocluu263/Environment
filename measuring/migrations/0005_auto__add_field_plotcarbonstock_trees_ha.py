...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlotCarbonStock.trees_ha'
        db.add_column(u'measuring_plotcarbonstock', 'trees_ha',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlotCarbonStock.trees_ha'
        db.delete_column(u'measuring_plotcarbonstock', 'trees_ha')
