...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreeAEQ.plot'
        db.add_column(u'measuring_treeaeq', 'plot',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mrvapi.Plot'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreeAEQ.plot'
        db.delete_column(u'measuring_treeaeq', 'plot_id')
    ...
    models = {
        ...
        u'measuring.treeaeq': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parcel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mrvapi.Parcel']"}),
            'plot': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mrvapi.Plot']", 'null': 'True'}),
