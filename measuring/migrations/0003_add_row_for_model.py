...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for i in orm['mrvapi.Project'].objects.all():
            projCarbon = orm['measuring.ProjectCarbonStock']()
            projCarbon.project = i
            projCarbon.save()

            for j in i.parcel_set.all():
                parcelCarbon = orm['measuring.ParcelCarbonStockTierThree']()
                parcelCarbon.parcel = j
                parcelCarbon.projectCarbonStock = projCarbon
                parcelCarbon.save()

                for k in j.plot_set.all():
                    plotCarbon = orm['measuring.PlotCarbonStock']()
                    plotCarbon.plot = k
                    plotCarbon.parcelCarbonStock = parcelCarbon
                    plotCarbon.save()
