...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlotCarbonStock.deadwood_tc_ha'
        db.alter_column(u'measuring_plotcarbonstock', 'deadwood_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PlotCarbonStock.litter_tc_ha'
        db.alter_column(u'measuring_plotcarbonstock', 'litter_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PlotCarbonStock.soc_tc_ha'
        db.alter_column(u'measuring_plotcarbonstock', 'soc_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'PlotCarbonStock.deadwood_tc_ha'
        db.alter_column(u'measuring_plotcarbonstock', 'deadwood_tc_ha', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'PlotCarbonStock.litter_tc_ha'
        db.alter_column(u'measuring_plotcarbonstock', 'litter_tc_ha', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'PlotCarbonStock.soc_tc_ha'
        db.alter_column(u'measuring_plotcarbonstock', 'soc_tc_ha', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        u'measuring.plotcarbonstock': {
            ...
            'dbh_sd': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'deadwood_tc_ha': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'estimated_n_trees': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'height_mean': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'height_sd': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'trees_ha': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'wsg_mean': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'wsg_sd': ('django.db.models.fields.FloatField', [], {'default': '0.0'})
        },
