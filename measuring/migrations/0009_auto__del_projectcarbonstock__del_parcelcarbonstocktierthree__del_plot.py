...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'measuring_plotcarbonstock', (
            ('agb_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('agb_tdm_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('parcelCarbonStock', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['measuring.ParcelCarbonStockTierThree'], null=True)),
            ('wsg_mean', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('soc_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('data_valid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dbh_mean', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('wsg_sd', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('deadwood_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('litter_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('height_sd', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('plot', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mrvapi.Plot'], unique=True)),
            ('bgb_tc_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('estimated_n_trees', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('trees_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('height_mean', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('dbh_sd', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('bgb_tdm_ha', self.gf('django.db.models.fields.FloatField')(null=True)),
        ))
