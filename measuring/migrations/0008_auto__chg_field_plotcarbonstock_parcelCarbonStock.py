...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlotCarbonStock.parcelCarbonStock'
        db.alter_column(u'measuring_plotcarbonstock', 'parcelCarbonStock_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['measuring.ParcelCarbonStockTierThree'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PlotCarbonStock.parcelCarbonStock'
        raise RuntimeError("Cannot reverse this migration. 'PlotCarbonStock.parcelCarbonStock' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PlotCarbonStock.parcelCarbonStock'
        db.alter_column(u'measuring_plotcarbonstock', 'parcelCarbonStock_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['measuring.ParcelCarbonStockTierThree']))
