//************************************************************************
    ...
    //
        ...
        function getPlots()
        {
            ...
            $.ajax({
                type: 'GET',
                url: '/api/v1/plot/?parcel=' + parcelid,
                dataType: 'json',
        ...
        function ajaxGetPlotSuccess(data)
        {
            ...
            {
                var plotSelect = $("<select id=\"plotDropdown\" class=\"form-control\" />");
...
<<<<<<< HEAD
                '<div style="margin-top:.5em;">' + mappedArea.toFixed(2) + '</div></div>' +
=======
...
>>>>>>> origin/master
                        ...
                        if (plotid != '')
                        {
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    $.ajax({
                                        url: '/api/v1/plot-carbon-stocks/' + plotid + '/',
                                        type: 'GET',
                                        dataType: 'json',
                                        success: function(carbon_stocks){

                                            var treeCount = carbon_stocks['inventory_n_trees'];
                                            ...
                                            $("#treesInv").html('' + treeCount + ' <a href="/measuring/data_management/plot_inventory/' + projectID + '/' + plotid + '/">[ View ]</a>');
		...
		$('#reported_area_form').on('submit', function(event){
			...
			{
				// Open a request to submit our form data
