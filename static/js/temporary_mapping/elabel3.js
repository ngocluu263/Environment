...
{div.style.opacity=this.percentOpacity/100;}
        ...
        //if(setview) console.log("initSetView success!");
}
...
ELabel.prototype.draw = function(force)
{
        ...
        this.div_.style.left = (p.x + this.pixelOffset.width + 10) + "px"; // added 10 to account for marker
...
ELabel.prototype.setContents = function(html)
{
        ...
        else
        {
                ...
                this.html = html;
                var temp = '<div class="'+ this.classname +'">' + this.html +'</div>';
...
ELabel.prototype.redraw = function(force) {
        if(this.getProjection() !== undefined)
        {
                ...
                if(this.div_ !== null)
                {
                        var h = parseInt(this.div_.clientHeight);
                        //var h = 0;
                        this.div_.style.left = (p.x + this.pixelOffset.width + 10) + "px";
                        this.div_.style.top = (p.y +this.pixelOffset.height - h) + "px";
                }
        }
/*        var p = this.getProjection().fromLatLngToDivPixel(this.point);
